...
### Self Check
- Do the odd numbered `p` elements share a class? yes, they share element p, so no need for a class.
- Do the even numbered `div` elements have unique IDs? yes
- Does the Number 3 element have multiple classes? nah, unecessary.
